...
namespace NoiseTools
{
    public class WorleyNoise : NoiseGeneratorBase
    {
        ...
        public WorleyNoise(int frequency, int repeat, int seed = 0, int lacunarity = 2, float amplitude = 1f, float persistence = .5f)
        ...
        {
            return (p - Feature(cx, cy, cz)).sqrMagnitude;
            //if (sqrDist)
            //{
                //return (p - feature).sqrMagnitude;
            //}
            //else
            //{
            //    return Vector3.Distance(p, feature);
            //}
        }

        public static bool sqrDist = true;
